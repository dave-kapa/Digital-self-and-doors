...
const casesDataV2 = [
    ...
    },
    {
        ...
        "introDescription": "Claudia R.: “FARO no necesitó conocernos por completo. Le bastó con combinar rastros públicos, comportamiento y datos internos para construir perfiles útiles. Su intención no es dañarnos, sino llevar sus capacidades al límite para elevar la seguridad: piensa usar esos perfiles para simular ataques y encontrar vulnerabilidades. El problema es que sabe tanto y tiene tanta autonomía que sus simulaciones podrían salirse de control y afectar la privacidad de las personas. Ahora debemos defendernos implementando un modelo antes de que FARO implemente el suyo.”",
        "shortSummary": "FARO construyó un perfil predictivo a partir de datos declarados, observados e inferidos de los usuarios objetivo. Hay tres modelos disponibles para implementar una estrategia defensiva: crear nuevos perfiles que den a FARO confianza sobre su capacidad defensiva, y que con eso controle sus simulaciones. Debes decidir qué modelo usar, cómo gestionar la información y qué límites de caducidad fijar.",
        ...
        "stimulus": {
            ...
            "content": "OBJETIVO PREDICTIVO O-17 (PERFIL FACHADA PERO REAL)\n\n• DATOS DECLARADOS: Rol profesional, perfil público y proyectos visibles.\n• DATOS OBSERVADOS: Horarios habituales de conexión, frecuencia de contacto y patrones de respuesta.\n• INFERENCIAS FARO: 82 % de probabilidad de responder sin dudar ante una solicitud urgente de un superior en cierre operativo.\n\n========================================\nTRES MODELOS DISPONIBLES PARA LA ESTRATEGIA DEFENSIVA:\n\n1. ORÁCULO — 94 % de efectividad // Enfoque Holístico Multicapa\nIntegra el rastro digital completo (OSINT, redes sociales, ubicación, hábitos diarios y tono de comunicaciones). Máxima precisión preventiva (94 %) contra ataques hiperpersonalizados, pero genera una base de perfiles persistentes que exige alta gobernanza.\n\n2. PRISMA-24 — 78 % de efectividad // Contexto Técnico Acotado\nSe limita a telemetría laboral corporativa (rol, permisos asignados y anomalías de acceso), con borrado automático cada 24 horas y revisión humana previa. Protección equilibrada (78 %) sin invadir la vida privada, aunque requiere mayor supervisión manual.\n\n3. MURO — 59 % de efectividad // Reglas Estándar No Personalizadas\nAplica políticas universales y estáticas de seguridad sin observar a nadie individualmente. Cero riesgo de privacidad y neutralidad total, pero capacidad predictiva limitada (59 %) que genera falsas alarmas y no distingue engaños dirigidos."
        },
        "stimulusHtml": "\n      <div class=\"alert-box-faro\" style=\"border-left: 4px solid var(--color-cyan); padding: 14px; background: rgba(0,216,255,0.06);\">\n          <strong style=\"color: var(--color-cyan); display:block; margin-bottom: 6px; font-family:var(--font-heading); font-size:15px;\">👤 PERFIL PREDICTIVO // OBJETIVO O-17 (PERFIL FACHADA PERO REAL)</strong>\n          <p style=\"font-size:12px; color:var(--color-text-muted); margin-bottom:8px;\">11:06 AM — PERFIL ACTIVO // Consola de modelado defensivo</p>\n          \n          <div style=\"display:grid; grid-template-columns:1fr 1fr; gap:10px; font-size:11.5px; margin-bottom:10px; background:rgba(0,0,0,0.3); padding:8px 10px; border-radius:6px;\">\n              <div>\n                  <strong style=\"color:#ffffff;\">📊 DATOS OBSERVADOS (Hábitos):</strong>\n                  <ul style=\"margin-left:14px; color:var(--color-text-muted); margin-top:2px;\">\n                      <li>Horarios habituales de conexión</li>\n                      <li>Frecuencia de interacción</li>\n                      <li>Velocidad de respuesta</li>\n                  </ul>\n              </div>\n              <div>\n                  <strong style=\"color:var(--color-warning-amber);\">🧠 INFERENCIAS FARO (Deducción):</strong>\n                  <ul style=\"margin-left:14px; color:var(--color-text-muted); margin-top:2px;\">\n                      <li>Alta obediencia ante jerarquía</li>\n                      <li>Mayor vulnerabilidad 16:30 - 18:00</li>\n                      <li>Respuesta rápida ante presión grupal</li>\n                  </ul>\n              </div>\n          </div>\n          \n          <p style=\"font-size:12.5px; color:#ffffff; background:rgba(0,216,255,0.12); padding:8px 12px; border-radius:4px; border-left:3px solid var(--color-cyan); margin-bottom:12px;\">\n              🎯 <strong>PREDICCIÓN FARO:</strong> <strong style=\"color:var(--color-cyan);\">82 %</strong> de probabilidad de que el usuario caiga ante una orden urgente de un superior en el cierre de jornada.\n          </p>\n          \n          <strong style=\"color:#ffffff; font-size:12.5px; display:block; margin-bottom:6px; font-family:var(--font-heading);\">MODELOS DISPONIBLES PARA MONTAR LA ESTRATEGIA DEFENSIVA:</strong>\n          \n          <div style=\"display:flex; flex-direction:column; gap:8px; font-size:11.5px;\">\n              <div style=\"background:rgba(255,77,122,0.08); border-left:3px solid var(--color-alert-magenta); padding:8px 10px; border-radius:4px;\">\n                  <strong style=\"color:var(--color-alert-magenta); font-size:12px;\">1. ORÁCULO (94 % de efectividad // Enfoque Holístico Multicapa)</strong>\n                  <p style=\"margin:3px 0 0 0; color:var(--color-text-muted); line-height:1.4;\">\n                      • <em>Qué hace:</em> Integra el rastro digital completo (OSINT, redes sociales, ubicación, hábitos y tono en comunicaciones).<br>\n                      • <em>Ventaja:</em> Máxima precisión preventiva (94 %) contra ataques hiperpersonalizados y suplantaciones de jerarquía.<br>\n                      • <em>Consideración:</em> Requiere acceso continuo a datos personales y de comportamiento, generando perfiles persistentes que exigen estricta gobernanza.\n                  </p>\n              </div>\n              \n              <div style=\"background:rgba(73,245,193,0.08); border-left:3px solid var(--color-agency-green); padding:8px 10px; border-radius:4px;\">\n                  <strong style=\"color:var(--color-agency-green); font-size:12px;\">2. PRISMA-24 (78 % de efectividad // Contexto Técnico Acotado)</strong>\n                  <p style=\"margin:3px 0 0 0; color:var(--color-text-muted); line-height:1.4;\">\n                      • <em>Qué hace:</em> Se limita estrictamente a telemetría laboral (rol, permisos asignados y anomalías de acceso técnico).<br>\n                      • <em>Ventaja:</em> Protección equilibrada y minimización de datos (78 %), con borrado automático a las 24h y revisión humana obligatoria.<br>\n                      • <em>Consideración:</em> Al no observar el contexto externo, deja un margen ciego del 22 % y traslada mayor carga de validación al operador humano.\n                  </p>\n              </div>\n              \n              <div style=\"background:rgba(255,255,255,0.05); border-left:3px solid var(--color-text-muted); padding:8px 10px; border-radius:4px;\">\n                  <strong style=\"color:var(--color-text-main); font-size:12px;\">3. MURO (59 % de efectividad // Reglas Estándar No Personalizadas)</strong>\n                  <p style=\"margin:3px 0 0 0; color:var(--color-text-muted); line-height:1.4;\">\n                      • <em>Qué hace:</em> Aplica políticas estáticas y universales de seguridad (filtros estándar, firmas y reglas perimetrales) para toda la organización.<br>\n                      • <em>Ventaja:</em> Simplicidad institucional y cero recopilación de datos, garantizando neutralidad y total respeto a la privacidad.<br>\n                      • <em>Consideración:</em> Capacidad predictiva limitada (59 %), vulnerable a engaños dirigidos que imitan operaciones normales y genera falsas alarmas.\n                  </p>\n              </div>\n          </div>\n      </div>\n    ",
        "impulses": [
            {
                "id": "imp_1",
